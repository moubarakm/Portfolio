...
#Reference : Reserve, F. (2019). Foreign Exchange Rates 2000-2019. Retrieved from https://www.kaggle.com/brunotly/foreign-exchange-rates-per-dollar-20002019 

Foreign_Exchange <- read_csv("Foreign_Exchange_Rates(CSV).csv")
View(Foreign_Exchange)
...
username <- "moubarakm"
apikey <- "VLq6kv3tf40bZgop89tn"

Sys.setenv("plotly_username"= username)
Sys.setenv("plotly_api_key"= apikey)
api_create(p3, filename = "DataVis Assignment3: Federal reserve time series data", sharing = "public")
